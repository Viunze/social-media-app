...
// URL API yang akan dibaca dari Vercel Environment Variables (VITE_API_URL)
    ...
    <header className="fixed top-0 left-0 right-0 bg-gray-900 border-b border-gray-700 shadow-lg z-10">
        <div className="max-w-7xl mx-auto flex justify-between items-center h-16 px-4 sm:px-6 lg:px-8">
            ...
            <nav className="flex items-center space-x-6">
                ...
                <button title="Notifications" className="text-gray-400 hover:text-yellow-400 transition duration-150 p-1">
                    {/* Ikon Notifikasi */}
                ...
                <button title="Profile" className="w-8 h-8 rounded-full bg-yellow-500 text-gray-900 font-semibold text-sm shadow-md hover:bg-yellow-400 transition duration-150">
                    CD
                </button>
            </nav>
        </div>
...
// Note: handleLike hanya contoh, perlu implementasi di App() atau custom hook
const PostCard = ({ post }) => {
                ...
                <div className="flex items-center">
                    ...
                    <div>
                        ...
                        <small className="text-gray-500 text-xs">
                            ...
                            {/* Menampilkan waktu yang lebih detail */}
...
const App = () => {
    ...
    const fetchPosts = async () => {
        ...
        try {
            ...
            setError('Gagal memuat feed. Pastikan API Backend (VITE_API_URL) sudah berjalan.');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handlePostSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error(`Gagal membuat postingan: ${response.statusText}`);
            }
    ...
    return (
        <div className="min-h-screen bg-gray-900">
            ...
            {/* Padding atas untuk menghindari header fixed */}
            <main className="pt-20 pb-8 px-4 sm:px-6 lg:px-8"> 
                ...
                {error && (
                    <div className="max-w-3xl mx-auto mt-8 p-4 bg-red-900/50 border border-red-500 text-red-300 rounded-lg">
                        {error}
                    </div>
                )}
